public class Data {
    ...
    //registration page
    public static final String email = "test123@gmail.com";
    public static final String password = "12345678";
    public static final String username = "Elena";
    public static final String phone = "7029577777";
    ...
    public static final String expectedUrlSearch = "https://romanceabroad.com/users";
